...
# Books
Rcrawler(Website = "https://www.amazon.com/gp/bestsellers/books/491316/ref=zg_b_bs_491316_1", no_cores = 2, no_conn = 2)
...
data = LoadHTMLFiles("amazon.com-281548", type = "list") # Books 1
...
write.csv(data_frame, "amazon_book_product_1.csv", row.names = FALSE)

# Saving the review_data_frame to a CSV file
write.csv(review_data_frame, "amazon_book_review_1.csv", row.names = FALSE)
...
write.csv(final_data_frame, "amazon_book_data_1.csv", row.names = FALSE)
