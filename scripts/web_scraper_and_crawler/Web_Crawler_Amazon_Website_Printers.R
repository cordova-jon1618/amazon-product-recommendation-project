...
Rcrawler(Website = "https://www.amazon.com/s?bbn=172574&rh=n%3A1064954%2Cn%3A172574%2Cn%3A172635&dc&qid=1714253480&rnid=172574&ref=lp_172574_nr_n_7", no_cores = 2, no_conn = 2)
...
data = LoadHTMLFiles("amazon.com-271437", type = "list")# Office Printer 2
...
write.csv(data_frame, "amazon_officeprinter_product_1.csv", row.names = FALSE)

# Saving the review_data_frame to a CSV file
write.csv(review_data_frame, "amazon_officeprinter_review_1.csv", row.names = FALSE)
...
write.csv(final_data_frame, "amazon_officeprinter_data_1.csv", row.names = FALSE)
