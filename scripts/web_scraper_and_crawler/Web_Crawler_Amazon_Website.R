...
write.csv(data_frame, "amazon_general_product.csv", row.names = FALSE)

# Saving the review_data_frame to a CSV file
write.csv(review_data_frame, "amazon_general_review.csv", row.names = FALSE)
...
write.csv(final_data_frame, "amazon_general_data.csv", row.names = FALSE)
